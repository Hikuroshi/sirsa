...
return [
    ...
    */
    ...
    'decimal' => 'Kolom :attribute harus memiliki :decimal angka di belakang desimal.',
    ...
    'in_array_keys' => 'Kolom :attribute harus berisi setidaknya salah satu key berikut: :values.',
    ...
    */
    ...
    'attributes' => [
        ...
        'model' => 'model AI',
        'ai_model_limit_id' => 'model AI',
        'secret' => 'API key',
        'priority' => 'prioritas',
        'rpm' => 'batas permintaan per menit (RPM)',
        'rpd' => 'batas permintaan per hari (RPD)',
        'tpm' => 'batas token per menit (TPM)',
